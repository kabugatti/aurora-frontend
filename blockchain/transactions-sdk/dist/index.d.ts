...
export interface Client {
     ...
     */
    add_transaction_received: ({ caller, address, amount }: {
        caller: string;
        address: string;
        amount: i128;
    }, options?: {
     ...
     */
    add_outgoing_transaction: ({ caller, address, amount }: {
        caller: string;
        address: string;
        amount: i128;
    }, options?: {
     ...
     */
    add_user_points: ({ caller, address, points_to_add }: {
        caller: string;
        address: string;
        points_to_add: i128;
    }, options?: {
     ...
     */
    reset_user_points: ({ caller, address }: {
        caller: string;
        address: string;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        add_transaction_received: (json: string) => AssembledTransaction<null>;
        add_outgoing_transaction: (json: string) => AssembledTransaction<null>;
        read_transactions_received: (json: string) => AssembledTransaction<Map<string, TransactionDetail>>;
        read_outgoing_transactions: (json: string) => AssembledTransaction<Map<string, TransactionDetail>>;
        read_total_transaction: (json: string) => AssembledTransaction<bigint>;
        read_cash_inflows: (json: string) => AssembledTransaction<bigint>;
        read_cash_outflows: (json: string) => AssembledTransaction<bigint>;
        reset_cash_inflows: (json: string) => AssembledTransaction<null>;
        reset_cash_outflows: (json: string) => AssembledTransaction<null>;
        read_tx_count: (json: string) => AssembledTransaction<bigint>;
        add_user_points: (json: string) => AssembledTransaction<null>;
        reset_user_points: (json: string) => AssembledTransaction<null>;
        read_user_points: (json: string) => AssembledTransaction<bigint>;
        read_all_user_points: (json: string) => AssembledTransaction<Map<string, bigint>>;
    };
}

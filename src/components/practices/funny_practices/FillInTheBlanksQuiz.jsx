          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="px-3 py-1 bg-[#030712] text-white border border-white rounded-lg hover:text-[#030712] hover:bg-red-50 flex items-center"
              >
        ...
        {isSubmitted ? (
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="py-2 px-6 bg-[#030712] flex items-center border border-white text-white hover:text-[#030712] rounded-lg hover:bg-red-50"
              >
              ...
              <Link
                to="/"
                className="py-2 px-6 bg-[#030712] border border-white flex items-center text-white rounded-lg hover:text-[#030712] hover:bg-red-50"
              >
                <Home className="mr-2" />
                Return Home
              </Link>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="py-2 px-8 bg-[#030712] border border-white text-white hover:text-[#030712] rounded-lg hover:bg-red-50 text-lg font-medium"
            >
              Submit Quiz
            </button>
          </div>

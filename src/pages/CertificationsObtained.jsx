...
const CertificationCard = ({ title, description, variant = 'pink' }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
      <div className={`h-40 relative ${variant === 'pink' ? 'bg-pink-400' : 'bg-blue-600'}`}>
        {/* Play button */}
        ...
        <div className="absolute bottom-4 right-4">
          <div className="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center">
            <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path d="M22 10L12 5 2 10l10 5 10-5zM6 12v4l6 3 6-3v-4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
